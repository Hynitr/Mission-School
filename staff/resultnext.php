                        ...
                        <div class="form-group">
                            ...
                            <select id="prin" class="form-control">
                                ...
                                <optgroup label="Improvement comments">
                                    <option id="prin">Needs to listen to directions fully so that he/she can learn
                                        to
                                        work independently
                                    </option>
                                    <option id="prin">Work well but needs to learn how to work better cooperatively
                                        with
                                        peers</option>
                                    <option id="prin">Gives up easily when something is difficult and needs
                                        extensive
